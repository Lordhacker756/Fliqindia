...
const Navbar = () => {
  return (
    <nav className="bg-[#131514] md:px-4 flex justify-between px-10 h-32 items-center">
      ...
      <div className="nav_btns">
        <button className="bg-gradient-to-b from-[#017B96] to-[#1E4047] font-[Inter] text-white rounded-full px-8 py-2 mx-2 sm:inline-block hidden">
          Sign Up
        </button>
        <button className="bg-gradient-to-b from-[#017B96] to-[#1E4047] font-[Inter] text-white rounded-full px-8 py-2 mx-2 hidden sm:inline-block">
          Sign In
        </button>
      </div>
    </nav>
